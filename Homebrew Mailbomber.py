...
#Boutons :
bouton_Start = Button(fen, text="Demarrer",command=Start) #Bouton Démarrer
bouton_Start.pack(pady=10)

bouton_Stop = Button(fen, text="Arrêter",command=Stop) #Bouton Arrêter
bouton_Stop.pack(pady=10)

bouton_Exit = Button(fen, text="Quitter",command=Exit) #Bouton Quitter
...
#Début des paramètres d'affichages graphique

#Fin des paramètres d'affichages graphique
